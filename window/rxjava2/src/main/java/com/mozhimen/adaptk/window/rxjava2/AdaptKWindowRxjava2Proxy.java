package com.mozhimen.adaptk.window.rxjava2;
...
public class AdaptKWindowRxjava2Proxy extends BaseWakeBefDestroyLifecycleObserver {
    public AdaptKWindowRxjava2Proxy() {
        super();
    }
